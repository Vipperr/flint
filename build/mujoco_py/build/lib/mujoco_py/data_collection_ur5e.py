...
class Data_collection_ur5e(Node):
    ...
    def save_files(self):
        ...
        if self.velocities:
            ...
            velocities.to_excel(file_path + "velocities.xlsx", index=False)
        ...
        if self.accelerations:
            ...
            accelerations.to_excel(file_path + "accelerations.xlsx", index=False)
        ...
        if self.efforts:
            ...
            efforts.to_excel(file_path + "efforts.xlsx", index=False)
